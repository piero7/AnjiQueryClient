...
namespace QueryClient
{
    ...
    public partial class LoginView : MahApps.Metro.Controls.MetroWindow
    {
        ...
        public LoginView()
        {
            ...
            //连接失败
            Messenger.Default.Register<GenericMessage<string>>(this, "connFail", (msg) =>
            {
    ...
    new GenericMessage<SystemMenagerService.LoginUser>(msg.Content), "loginSuccess");
            ...
            //手动触发更新
            Messenger.Default.Register<GenericMessage<string>>(this, "update",
             (msg) => DispatcherHelper.CheckBeginInvokeOnUI(
                 new System.Action(
                 () =>
                 {
                     this.vm.UserName = this.userName_tb.Text;

                     //TODO Update the password value
                 })));
            #endregion
