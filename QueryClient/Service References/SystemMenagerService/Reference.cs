...
namespace QueryClient.SystemMenagerService {
    ...
    public interface ISystemManagerService {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISystemManagerService/ChangePwd", ReplyAction="http://tempuri.org/ISystemManagerService/ChangePwdResponse")]
        int ChangePwd(int userId, string eOPwd, string ePwd);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISystemManagerService/ChangePwd", ReplyAction="http://tempuri.org/ISystemManagerService/ChangePwdResponse")]
        System.Threading.Tasks.Task<int> ChangePwdAsync(int userId, string eOPwd, string ePwd);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface ISystemManagerServiceChannel : global::QueryClient.SystemMenagerService.ISystemManagerService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class SystemManagerServiceClient : System.ServiceModel.ClientBase<global::QueryClient.SystemMenagerService.ISystemManagerService>, global::QueryClient.SystemMenagerService.ISystemManagerService {
        ...
        public int ChangePwd(int userId, string eOPwd, string ePwd) {
            return base.Channel.ChangePwd(userId, eOPwd, ePwd);
        }
        
        public System.Threading.Tasks.Task<int> ChangePwdAsync(int userId, string eOPwd, string ePwd) {
            return base.Channel.ChangePwdAsync(userId, eOPwd, ePwd);
        }
